...
export type BottomNavigationProp = NativeStackNavigationProp<Partial<BottomNavigationStackParamList>>;

export type CombineNavigationProp = NativeStackNavigationProp<Partial<CombinedBottomAndAppNavigationStackParamList>>;
export type CodebarUpdateNavigationProp = NativeStackNavigationProp<Partial<CodebarUpdateNavigationStackParamList>>
