...
} from './InventoryBagProvider';

type InventoryBagActionType =
  | {
      type: '[InventoryBag] - Post Inventory';
      payload: inventoryDataInterface | undefined;
    }
  | {
      type: '[InventoryBag] - Post Inventory Details';
...
export const innventoryBagReducer = (
  state: InventoryBagInterface,
  action: InventoryBagActionType,
): InventoryBagInterface => {
  switch (action.type) {
