...
export const ConfirmationScreen = () => {
  ...
  const {bag, cleanBag, numberOfItems, postInventory} =
  ...
  const protectThisPage =
    numberOfItems <= 0 && !createInventaryLoading ? true : false;
  ...
  return !protectThisPage ? (
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <>
              <View
                style={
                  ConfirmationScreenStyles(theme, typeTheme).confirmationHeader
                }>
                <View
                  style={
                    ConfirmationScreenStyles(theme, typeTheme)
              ...
              <View
                ...
                <Text
                  style={
                    ConfirmationScreenStyles(theme, typeTheme).confirmationText
                  }>
    ...
    <SafeAreaView
      style={ConfirmationScreenStyles(theme, typeTheme).ConfirmationScreen}>
      <View
        style={
          ConfirmationScreenStyles(theme, typeTheme)
